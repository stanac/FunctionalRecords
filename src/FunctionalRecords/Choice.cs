...
public readonly record struct Choice<T1, T2> : IChoice
{
    ...
    private Choice(T1 choice1)
    {
        ...
        SelectedIndex = 1;
        _choice1 = choice1;
        SelectedTypeName = new TypeName(typeof(T1)).ShortName;
    }
    ...
    private Choice(T2 choice2)
    {
        ...
        SelectedIndex = 2;
        _choice2 = choice2;
        SelectedTypeName = new TypeName(typeof(T2)).ShortName;
    }
...
public readonly record struct Choice<T1, T2, T3> : IChoice
{
    private readonly T1? _choice1 = default;
    private readonly T2? _choice2 = default;
    ...
    private Choice(T3 choice3)
    {
        ...
        SelectedIndex = 3;
        _choice3 = choice3;
        SelectedTypeName = new TypeName(typeof(T3)).ShortName;
    }
...
public readonly record struct Choice<T1, T2, T3, T4> : IChoice
{
    private readonly T1? _choice1 = default;
    private readonly T2? _choice2 = default;
    private readonly T3? _choice3 = default;
    ...
    private Choice(T4 choice4)
    {
        ...
        SelectedIndex = 4;
        _choice4 = choice4;
        SelectedTypeName = new TypeName(typeof(T4)).ShortName;
    }
...
public readonly record struct Choice<T1, T2, T3, T4, T5> : IChoice
{
    private readonly T1? _choice1 = default;
    private readonly T2? _choice2 = default;
    private readonly T3? _choice3 = default;
    ...
    private Choice(T5 choice5)
    {
        ...
        SelectedIndex = 5;
        _choice5 = choice5;
        SelectedTypeName = new TypeName(typeof(T5)).ShortName;
    }
...
public readonly record struct Choice<T1, T2, T3, T4, T5, T6> : IChoice
{
    private readonly T1? _choice1 = default;
    private readonly T2? _choice2 = default;
    private readonly T3? _choice3 = default;
    ...
    private Choice(T6 choice6)
    {
        ...
        SelectedIndex = 6;
        _choice6 = choice6;
        SelectedTypeName = new TypeName(typeof(T6)).ShortName;
    }
